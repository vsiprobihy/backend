# Generated by Django 4.2.16 on 2024-12-30 09:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, max_length=255, null=True, upload_to=authentication.models.customer_image_file_path, validators=[utils.data_validatiors.validate_image_file, utils.data_validatiors.validate_file_size])),
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('organizer', 'Organizer'), ('admin', 'Administrator')], default='user', max_length=10)),
